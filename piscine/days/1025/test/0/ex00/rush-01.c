...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/10/25 16:08:28 by hyospark          #+#    #+#             */
/*   Updated: 2020/10/25 20:22:39 by hyospark         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_all(int row, int col, char table[row][col])
{
	int r;
	int c;
...
int 	check_rows(char table[4][4], int i, int j, int row)
{
	int temp = table[i][j];
	int z = 0;
	int a = 3;
...
int 	check_cols(char table[4][4], int i, int j, int col)
{
	int temp = table[i][j];
	int z = 0;
	int a = 3;
